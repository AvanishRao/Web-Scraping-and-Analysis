...
class data_ingestion:        
    ...
    def secondary(self):
        ...
        data = pd.read_excel('E:\\For_Job\\Code\\Notebook\\data\\Input.xlsx')
        ...
        for i, url in enumerate(df['URL']):
            ...
            file_path = 'E:\For_Job\Code\Text_files' #Path to store text files
            space = " "
    ...
    def Handdle_Blank_link(self,blank_data): # same as above method but this method is used for extracting those text which are not extracted by secondary method
        ...
        for item in blank_data:
            ...
            if alldiv is not None:
                ...
                file_path = 'E:\For_Job\Code\Text_files'
                space = " "                
    ...
    def merged(self,df1,df2): #
        ...
        merged_df.to_csv('E:\\For_Job\\Code\\Notebook\\data\\final.csv', index=False) # dataframe is saved in csv format
        return merged_df
